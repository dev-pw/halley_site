        ...
        <div class="container">
            <div class="row justify-content-between gy-4">
                ...
                <div class="col-md-6 col-lg-3">
                    <img src="<?php echo wp_get_attachment_url('33'); ?>" alt="">
                </div>

                <div class="col-md-6 col-lg-2 text-white">
                    <h3 class="mb-4">Sobre nós</h3>
                    <p class="small m-0"><a href="#" class="link-light text-decoration-none">Fale com a Halley</a></p>
                    <p class="small m-0"><a href="#" class="link-light text-decoration-none">Logística</a></p>
                    <p class="small m-0"><a href="#" class="link-light text-decoration-none">Somos Halley</a></p>
                </div>

                <div class="col-md-6 col-lg-3 text-white">
                    <h3 class="mb-4">Principais Serviços</h3>
                    <p class="small m-0"><a href="#" class="link-light text-decoration-none">Transporte de Material Biológico</a></p>
                    <p class="small m-0"><a href="#" class="link-light text-decoration-none">Transporte de Produtos Farmacêuticos</a></p>
                    <p class="small m-0"><a href="#" class="link-light text-decoration-none">Transporte de Carga Seca</a></p>
                </div>
