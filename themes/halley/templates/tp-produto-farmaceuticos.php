        ...
        <div class="container">
            ...
            <div class="row gy-4">
                ...
                <div class="col-md-6 mx-auto col-lg-4">
                    <img class="img-fluid rounded-top-5 rounded-end-5" src="<?= wp_get_attachment_image_src(107, 'full')[0]; ?>" alt="<?= get_post(107)->post_title; ?>">
                </div>
    ...
    <div class="container">
        ...
        <div class="row gy-4">
            ...
            <div class="col-md-6 col-lg-4">
                ...
                <p class="h5 mt-3 text-center text-primary">Transporte seguro de carga seca</p>
            </div>

            <div class="col-md-6 col-lg-4">
                <img src="<?= wp_get_attachment_url('108'); ?>" class="w-100 rounded-4" alt="<?= get_post(108)->post_title; ?>">
                <p class="h5 mt-3 text-center text-primary">Logística hospitalar</p>
            </div>
