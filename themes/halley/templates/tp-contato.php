    ...
    <div class="u-py-5">
        <div class="container">
            <div class="row gy-4 justify-content-center">
                ...
                <div class="col-lg-4">
                    <div class="border border-4 bg-light rounded p-4 d-flex flex-column text-center align-items-center h-100">
                        <span class="fs-2 icon-location_on mb-3 text-primary"></span>
                        <h2 class="h5 mb-3 text-primary">Endereço</h2>
            ...
            <div class="bg-light flex-column-reverse flex-xl-row mt-5 mx-0 rounded-3 row border border-4">
                <div class="col-xl-5 p-0 s-mapa-contato">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3657.3386628485155!2d-46.61841615817891!3d-23.55627736860583!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce59f9adb65883%3A0xe37da38c315d2e10!2sHalley%20Log%C3%ADstica%20e%20Transporte%20LTDA!5e0!3m2!1spt-BR!2sbr!4v1759862740506!5m2!1spt-BR!2sbr" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
                <div class="col-xl-7">
