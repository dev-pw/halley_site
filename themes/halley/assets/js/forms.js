jQuery(document).ready(function ($) {
    ...
    $('.form_news').submit(function (evt) {
      ...
      let configForm = {
        ...
        mostrar_mensagem: true,
        texto_sucesso: "Cadastro realizado com sucesso",
        desc_sucesso: "Agradecemos pelo cadastro, mais novidade em breve!",
        redirect: false,
        link_redirect_dinamico: false,
        link_redirect: '',
        redirect_com_var: false,
    ...
    function submitForm(form, configForm){
      ...
      $.ajax({
        type : 'POST',
        url  : form_action_caminho+'/handlers/'+form_action+'.php',
        data : formData,
        dataType: 'json',
        contentType: false,
        processData: false,
