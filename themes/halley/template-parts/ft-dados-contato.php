    ...
    <div class="container">
        <div class="row justify-content-between gy-4">
            <div class="col-md-6 col-lg-3 text-center ">
                ...
                <p class="text-primary">Rua Odorico Mendes, 491 <br> Mooca • São Paulo - SP - 03106-030</p>
            </div>
            <div class="col-md-6 col-lg-3 text-center ">
                <div class="d-flex justify-content-center align-itens-center rounded-4 bg-secondary p-4 mx-auto" style="width: 75px; height: 75px;">
                ...
                <p class="text-primary">+55 11 5034 5555 <br>
                +55 11 2271 0030</p>
            </div>
            <div class="col-md-6 col-lg-3 text-center ">
                <div class="d-flex justify-content-center align-itens-center rounded-4 bg-secondary p-4 mx-auto" style="width: 75px; height: 75px;">
                ...
                <p class="text-primary">atendimento@halleylog.com.br</p>
            </div>
        </div>
    </div>
</section>
